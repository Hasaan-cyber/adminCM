...
public class UserTypesTest extends BaseClass {
	...
	/*
	 * @Test(priority = 5, enabled = true) public void verifyEmailPlaceholder() {
	 * 
	 ...
	 * }
	 * 
	 * @Test(priority = 6, enabled = true) public void verifyCursorPosition() {
	 * 
	 * WebElement activeElement = driver.switchTo().activeElement();
	 * 
	 * Assert.assertTrue(forgotPasswordPage.getInputFieldEmail().equals(
	 * activeElement));
	 * 
	 * }
	 * 
	 ...
	 * verifyMalformedEmailErrorMessage() {
	 * 
	 ...
	 * verifyUnRegisteredEmailErrorMessage() {
	 * 
	 * for (int i = 0; i < 3; i++) {
	 * 
	 * forgotPasswordPage.enterThreeRandomUnRegisteredEmails();
	 * 
	 * actualErrorAccountNotRegistered =
	 * forgotPasswordPage.getUnregisteredEmailErrorMessage();
	 * Assert.assertEquals(actualErrorAccountNotRegistered,
	 * expectedErrorAccountNotRegistered);
	 * 
	 ...
	 * }
	 * 
	 * @Test(priority = 11, enabled = true) public void verifyForgetImageDisplayed()
	 * {
	 * 
	 * Assert.assertTrue(forgotPasswordPage.getPageImage().isDisplayed(),
	 * "Image not displayed");
	 * 
	 * }
	 */
